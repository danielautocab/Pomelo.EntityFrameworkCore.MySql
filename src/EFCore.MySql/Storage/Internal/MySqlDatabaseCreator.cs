...
namespace Pomelo.EntityFrameworkCore.MySql.Storage.Internal
{
    ...
    public class MySqlDatabaseCreator : RelationalDatabaseCreator
    {
        ...
        private static void ClearAllPools() => MySqlConnector.MySqlConnection.ClearAllPools();

        // Clear connection pool for the database connection since after the 'create database' call, a previously
        // invalid connection may now be valid.
        private void ClearPool() => MySqlConnector.MySqlConnection.ClearPool((MySqlConnection)_relationalConnection.DbConnection);
    }
}
